#ifndef CLIB_QUEUE_CONCURRENCY_MPMC_HPP
#define CLIB_QUEUE_CONCURRENCY_MPMC_HPP
...
namespace clib {
    namespace queue {
        ...
        class Mpmc : public Base<Type, UsingCPUCacheLine> {
        private:
        ...
        public:
            ...
            Mpmc(const Mpmc& other) = delete;

            Mpmc& operator=(Mpmc&& other) = delete;
            Mpmc& operator=(const Mpmc& other) = delete;
            ...
            explicit Mpmc(const size_t size)
                : Base<Type, UsingCPUCacheLine>{ size },
                  head{ 0 },
                  tail{ 0 } {}

            virtual ~Mpmc() noexcept {}
...
#endif // !CLIB_QUEUE_CONCURRENCY_MPMC_HPP
